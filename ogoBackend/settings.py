"""
Django settings for ogoBackend project.
...
SECRET_KEY = 'django-insecure-09_fghr!ngrk^w9%af#npz6^b2o6(8-m2q%n(7z966fu+vy+97'
...
WSGI_APPLICATION = 'ogoBackend.wsgi.application'
...
# cred = credentials.Certificate('D:/Flutter/New folder/ogoBackend/firebase_credentials.json')
cred = credentials.Certificate('config/firebase_credentials.json')
firebase_admin.initialize_app(cred)

# Creating a user according to the roles 
